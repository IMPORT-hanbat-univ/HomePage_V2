  ...
  return (
    <>
      <div className="h-screen w-full  flex items-center justify-center flex-wrap">
        <Link href={"about/notice"} className="p-3 border rounded bg-import-color text-white mr-3">
          공지사항
        </Link>
        <Link href={"about/notice/1"} className="p-3 border rounded bg-import-color text-white mr-3">
          상세보기
        </Link>
