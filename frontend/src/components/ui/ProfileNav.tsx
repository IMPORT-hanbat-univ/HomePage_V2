  ...
  return (
    <div className="flex flex-col gap-6  rounded-[10px] border bg-white border-[#E2E2E2] w-fit  px-10 py-4  shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
      <button
        ...
        className={`flex  group items-center gap-9 ${category === "profile" && "text-import-color"}`}
      >
        <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            className="group-hover:stroke-import-color"
          />
          <path
        ...
        <span className="group-hover:text-import-color text-[15px] tracking-[-0.225px]">프로필</span>
      </button>
      <button
        onClick={() => handleCategory("activity")}
        className={`flex  group items-center gap-9 ${category === "activity" && "text-import-color"}`}
      >
        <svg
          width="16"
          height="13"
        ...
        <span
          className="group-hover:text-import-color
 text-[15px] tracking-[-0.225px] line-clamp-1"
        >
          나의 활동
        </span>
      </button>
