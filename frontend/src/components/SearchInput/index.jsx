...
export default function SearchInput() {
    ...
    const submitSearch = (e) => {
        ...
        if(search.trim() === ""){
            ...
            router.push({pathname: router.pathname, query: {...router.query, search: search.trim()}}, undefined, {shallow: true})
        }
    ...
    return (
        <form onSubmit={submitSearch} className='flex mb-2'>
            <div className='w-full h-12 px-3 pt-2 pb-1 overflow-x-hidden overflow-y-auto flex items-center border border-zinc-300 rounded'>
                <svg className='mt-1 mr-2 overflow-hidden' width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    <path 
                        fill="#212529" 
                        fillRule="evenodd" 
                        clipRule="evenodd" 
